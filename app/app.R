...
#   3. set working directory to app.R directory (setwd("I:/PEOPLEPROJECTIONS/00 - R_code/shiny_apps/Production/popProjApp/app"))
#      (Or, in Files pane, in app folder, click on "More", then "Set As Working Directory")
#   4. deployApp(appName = "popProjApp", appId = 1421553)
    ...
    column(width = 12, 
           ...
           tags$header(class="header", style="padding:0 0px 0 0px; display:flex; height:80px; width:100%;",
             tags$div(class="banner", style="display:flex; justify-content:flex-start; align-items:center; margin: 0 10px 0 10px",
               ...
               h1("British Columbia - Population Projections", style="font-weight:400; color:white; margin: 5px 5px 0 18px;")
             )
           )
    ),
    column(width = 12,
